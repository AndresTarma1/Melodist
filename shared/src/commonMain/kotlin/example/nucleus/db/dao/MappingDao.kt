...
class MappingDao(private val database: MusicPlayerDatabase) {
    ...
    ) = example.nucleus.db.entities.ArtistEntity(
    ...
    ) = example.nucleus.db.entities.AlbumEntity(
    ...
    fun artistsForSong(songId: String): List<example.nucleus.db.entities.ArtistEntity> {
    ...
    fun albumForSong(songId: String): example.nucleus.db.entities.AlbumEntity? {
